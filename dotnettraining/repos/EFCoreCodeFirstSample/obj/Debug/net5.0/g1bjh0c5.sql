...
VALUES (N'20210628113410_EFCoreCodeFirstSample.Models.EmployeeContext', N'5.0.7');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20210629034220_EFCoreCodeFirstSample.Models.EmployeeContextSeed', N'5.0.7');
GO
...
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'EmployeeId', N'DateOfBirth', N'Email', N'FirstName', N'LastName', N'PhoneNumber') AND [object_id] = OBJECT_ID(N'[Employees]'))
    SET IDENTITY_INSERT [Employees] ON;
INSERT INTO [Employees] ([EmployeeId], [DateOfBirth], [Email], [FirstName], [LastName], [PhoneNumber])
VALUES (CAST(3 AS bigint), '1988-03-23T00:00:00.0000000', N'Anna.Stew@gmail.com', N'Anna', N'Stewart', N'131-442-3553');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'EmployeeId', N'DateOfBirth', N'Email', N'FirstName', N'LastName', N'PhoneNumber') AND [object_id] = OBJECT_ID(N'[Employees]'))
    SET IDENTITY_INSERT [Employees] OFF;
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20210629045611_EFCoreCodeFirstSample.Models.EmployeeContext2', N'5.0.7');
GO
